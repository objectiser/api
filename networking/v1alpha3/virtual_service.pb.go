...
type HTTPRoute struct {
	...
	// Identify request as a health check
	HealthCheck *HealthCheck `protobuf:"bytes,12,opt,name=health_check,json=healthCheck" json:"health_check,omitempty"`
}
...
func (m *HTTPRoute) GetHealthCheck() *HealthCheck {
	if m != nil {
...
// HealthCheck can be used to identify a request as a health check, and determine
// whether it should be passed through or handled based on a cached response.
type HealthCheck struct {
	// Specifies whether the filter operates in pass through mode or not.
	PassThroughMode bool `protobuf:"varint,1,opt,name=pass_through_mode,json=passThroughMode,proto3" json:"pass_through_mode,omitempty"`
	// If operating in pass through mode, the amount of time in milliseconds
	// that the filter should cache the upstream response.
	CacheTime *google_protobuf.Duration `protobuf:"bytes,2,opt,name=cache_time,json=cacheTime" json:"cache_time,omitempty"`
}

func (m *HealthCheck) Reset()                    { *m = HealthCheck{} }
func (m *HealthCheck) String() string            { return proto.CompactTextString(m) }
func (*HealthCheck) ProtoMessage()               {}
func (*HealthCheck) Descriptor() ([]byte, []int) { return fileDescriptorVirtualService, []int{14} }

func (m *HealthCheck) GetPassThroughMode() bool {
	if m != nil {
...
func (m *HTTPRoute) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HealthCheck != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(m.HealthCheck.Size()))
...
func (m *HTTPMatchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Scheme != nil {
		...
		n11, err := m.Scheme.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
	...
	if m.Method != nil {
		...
		n12, err := m.Method.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
	...
	if m.Authority != nil {
		...
		n13, err := m.Authority.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *PortSelector) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Port != nil {
		nn26, err := m.Port.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn26
...
func (m *HealthCheck) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CacheTime != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(m.CacheTime.Size()))
		n27, err := m.CacheTime.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
var fileDescriptorVirtualService = []byte{
	...
	,
}
