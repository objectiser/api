...
_HTTPROUTE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='health_check', full_name='istio.networking.v1alpha3.HTTPRoute.health_check', index=11,
...
_HEALTHCHECK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pass_through_mode', full_name='istio.networking.v1alpha3.HealthCheck.pass_through_mode', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cache_time', full_name='istio.networking.v1alpha3.HealthCheck.cache_time', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HTTPROUTE.fields_by_name['health_check'].message_type = _HEALTHCHECK
