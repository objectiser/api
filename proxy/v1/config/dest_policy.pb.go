...
//
// A single DestinationPolicy resource includes configuration for all service versions. Only
...
type DestinationPolicy struct {
	...
	// REQUIRED. List of policies, one per service version. # DEPRECATED: will be removed soon
	Policy []*DestinationVersionPolicy `protobuf:"bytes,5,rep,name=policy" json:"policy,omitempty"`
...
func (m *DestinationVersionPolicy) GetLabels() map[string]string {
	if m != nil {
		return m.Labels
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
